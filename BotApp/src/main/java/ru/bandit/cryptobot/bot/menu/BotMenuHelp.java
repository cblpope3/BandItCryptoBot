...
public class BotMenuHelp implements MenuItem {
    ...
    public String getText(Long userId, List<String> param) {
        return "- Все команды должны начинаться со знака “/”. Например /start, /help, /ONCE/BTC/USD\n" +
                ...
                "- /target/cur1/cur2/dir/val - создать подписку на достижение целевого изменения (повышение или понижение) от текущего курса на заданный процент, где cur1 и cur2 - коды доступных валют, dir - целевое направление изменения UP || DOWN, val - значение изменения в %. Пример /target/btc/rub/up/10. Соответствует кнопке Будильник.\n" +
                "- /average/cur1/cur2/period - создать подписку на среднее значение за период времени period в минутах. Соответствует кнопке Среднее.\n" +
