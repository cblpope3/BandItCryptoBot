...
public class BotRequestProcessor {
    ...
    public static final int ALREADY_SUBSCRIBED = 4;
    ...
    public String processRequest(Message message) {
        ...
        switch (separatedMessage.get(0)) {
            ...
            case "/stop":
                ...
                if (commandStatus == OK) return "До встречи!";
    ...
    public int processSubscription(long chatId, String figi) {
